...
startPath = 'Root directory where you want to start from'


new_file = "apth where you want to place all your photos"
...
def checkPath(path,new_file,exclude_folders) : 
    ...
    for i in dir_list : 
        ...
        if(os.path.isfile(filename)):
            ...
            if(file_ext == ".jpeg" or file_ext ==".png" or file_ext == ".jpeg"):
                print(filename)
                try : 
                    count = main(filename)
